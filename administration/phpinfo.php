...
if ($_GET['page']==3) {
	...
	str_replace("..", "", IMAGES) => true,
	str_replace("..", "", IMAGES) .'imagelist.js' => true,
	str_replace("..", "", IMAGES_A) => true,
	str_replace("..", "", IMAGES) .'avatars/' => true,
	str_replace("..", "", IMAGES_N) => true,
	str_replace("..", "", IMAGES) .'images/' => true,
	str_replace("..", "", IMAGES) .'files/' => true,
	str_replace("..", "", IMAGES) .'flash/' => true,
	str_replace("..", "", IMAGES) .'smiley/' => true,
	// str_replace("..", "", IMAGES_N) .'thumbs/' => true,
	...
	str_replace("..", "", COMPONENTS) .'robots.txt' => true,
	'config.php' => false
	);
