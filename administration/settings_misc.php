...
echo "<option value='2'".($settings['tinymce_enabled'] == "2" ? " selected='selected'" : "").">".$locale['542']."</option>\n";
echo "<option value='1'".($settings['tinymce_enabled'] == "1" ? " selected='selected'" : "").">".$locale['541']."</option>\n";
