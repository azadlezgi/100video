...
if (iMEMBER) {
	...
	echo THEME_BULLET." <a href='".BASEDIR."login.php?logout=yes' class='side'>".$locale['global_124']."</a>\n";
	...
	if (!preg_match('/login.php/i',FUSION_SELF)) {
		...
		echo $locale['global_101']."<br />\n<input type='text' name='user_name' class='textbox' style='width:195px' /><br />\n";
		echo $locale['global_102']."<br />\n<input type='password' name='user_pass' class='textbox' style='width:195px' /><br />\n";
		echo "<label><input type='checkbox' name='remember_me' class='checkbox' value='y' title='".$locale['global_103']."' /> ".$locale['global_103']."</label>\n";
